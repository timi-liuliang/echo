...
namespace LORD
{
	...
	{
	public:
		GLES2TargetTaskCreateFrameBuffer(GLES2TargetGPUProxy* target_proxy, GLES2TextureGPUProxy* texture_proxy, PixelFormat pixel_format, uint width, uint height);
		void Execute();
	...
	{
	public:
		GLES2TargetTaskCreateDepthBuffer(GLES2TargetGPUProxy* target_proxy, GLES2TextureGPUProxy* texture_proxy, uint width, uint height);
		void Execute();
	...
	{
	public:
		GLES2TargetTaskCreateFrameBufferCube(GLES2TargetGPUProxy* target_proxy, GLES2TextureGPUProxy* texture_proxy, PixelFormat pixel_format, uint width, uint height);
		void Execute();
	...
	{
	public:
		GLES2TargetTaskCreateDepthBufferCube(GLES2TargetGPUProxy* target_proxy, uint width, uint height);
		void Execute();
	...
	{
	public:
		GLES2TargetTaskBindTargetLeft(GLES2TargetGPUProxy* target_proxy, uint width, uint height);
		void Execute();
	...
	{
	public:
		GLES2TargetTaskBindTargetRight(GLES2TargetGPUProxy* target_proxy, uint width, uint height);
		void Execute();
	...
	{
	public:
		GLES2TargetTaskReadPixels(GLES2TargetGPUProxy* target_proxy, uint width, uint height, void* pixels);
		void Execute();
