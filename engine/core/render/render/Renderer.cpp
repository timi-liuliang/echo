...
namespace Echo
{
	...
	// 新建Renderable
	Renderable* Renderer::createRenderable(RenderQueue* renderQueue, Material* material)
	{
		Renderable* renderable = EchoNew(Renderable(renderQueue, material, m_renderableIdentifier++));
