...
namespace Echo
{
    class ShaderNodeAddition : public ShaderNode
    {
        ECHO_CLASS(ShaderNodeAddition, ShaderNode)

    public:
        ShaderNodeAddition();
        virtual ~ShaderNodeAddition() {}

		// name
		virtual QString name() const override { return QStringLiteral("Addition"); }

        // caption
        virtual QString caption() const override { return QStringLiteral("Addition"); }
