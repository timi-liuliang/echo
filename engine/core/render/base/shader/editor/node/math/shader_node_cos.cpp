...
namespace Echo
{
	...
	void ShaderNodeCos::bindMethods()
	{

	}

    void ShaderNodeCos::setInData(std::shared_ptr<NodeData> nodeData, QtNodes::PortIndex portIndex)
    {
    ...
    bool ShaderNodeCos::generateCode(Echo::ShaderCompiler& compiler)
    {
        if (m_inputs[0])
        {
