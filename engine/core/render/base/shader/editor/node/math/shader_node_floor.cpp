...
namespace Echo
{
    ShaderNodeFloor::ShaderNodeFloor()
    {
        m_inputDataTypes = 
        {
            {"any", "A"},
	...
	void ShaderNodeFloor::bindMethods()
	{

	}

    void ShaderNodeFloor::setInData(std::shared_ptr<NodeData> nodeData, QtNodes::PortIndex portIndex)
    {
    ...
    bool ShaderNodeFloor::generateCode(Echo::ShaderCompiler& compiler)
    {
        if (m_inputs[0])
        {
