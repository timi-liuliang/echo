#include "shader_node_one_minus.h"
...
namespace Echo
{
    ShaderNodeOneMinus::ShaderNodeOneMinus()
        : ShaderNode()
    {
        m_inputDataTypes = 
        {
	...
	void ShaderNodeOneMinus::bindMethods()
	{

	}

    void ShaderNodeOneMinus::setInData(std::shared_ptr<NodeData> nodeData, QtNodes::PortIndex portIndex)
    {
    ...
    bool ShaderNodeOneMinus::generateCode(Echo::ShaderCompiler& compiler)
    {
        if (m_inputs[0])
        {
