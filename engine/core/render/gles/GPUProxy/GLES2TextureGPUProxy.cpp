...
namespace Echo
{
	...
	void GLES2TextureGPUProxy::create2D(PixelFormat pixFmt, Dword usage, ui32 width, ui32 height, ui32 numMipmaps, const Buffer& buff, ui32 face_num)
	{
	...
	void GLES2TextureGPUProxy::createCube(PixelFormat pixFmt, Dword usage, ui32 width, ui32 height, ui32 numMipmaps, const Buffer& buff, ui32 pixelsSize)
	{
	...
	void GLES2TextureGPUProxy::updateSubTex2D(PixelFormat pixel_format, ui32 level, const Rect& rect, void* pData)
	{
		OGLESDebug(glBindTexture(GL_TEXTURE_2D, m_hTexture));
