...
namespace Echo
{
	...
	GLES2DepthStencilViewTaskCreateView::GLES2DepthStencilViewTaskCreateView(GLES2DepthStencilViewGPUProxy* proxy, PixelFormat pixFmt, ui32 width, ui32 height)
	...
	{
		m_proxy->destroyView();
		EchoSafeDelete(m_proxy, GLES2DepthStencilViewGPUProxy);
	}
