...
namespace Echo
{
	...
	GLES2TargetTaskCreateFrameBuffer::GLES2TargetTaskCreateFrameBuffer(GLES2TargetGPUProxy* target_proxy, GLES2TextureGPUProxy* texture_proxy, 
		PixelFormat pixel_format, ui32 width, ui32 height)
	...
	void GLES2TargetTaskDestroyFrameBuffer::Execute()
	{
		...
		EchoSafeDelete(m_proxy, GLES2TargetGPUProxy);
	}


	GLES2TargetTaskCreateDepthBuffer::GLES2TargetTaskCreateDepthBuffer(GLES2TargetGPUProxy* target_proxy, GLES2TextureGPUProxy* texture_proxy, ui32 width, ui32 height)
		: GLES2TargetTaskBase(target_proxy)
	...
	GLES2TargetTaskCreateFrameBufferCube::GLES2TargetTaskCreateFrameBufferCube(GLES2TargetGPUProxy* target_proxy, GLES2TextureGPUProxy* texture_proxy, PixelFormat pixel_format, ui32 width, ui32 height)
		: GLES2TargetTaskBase(target_proxy)
		, m_frame_texture_proxy(texture_proxy)
		, m_pixel_format(pixel_format)
		, m_width(width)
	...
	GLES2TargetTaskCreateDepthBufferCube::GLES2TargetTaskCreateDepthBufferCube(GLES2TargetGPUProxy* target_proxy, ui32 width, ui32 height)
		: GLES2TargetTaskBase(target_proxy)
		, m_width(width)
		, m_heidht(height)
	{
	...
	GLES2TargetTaskBindTargetLeft::GLES2TargetTaskBindTargetLeft(GLES2TargetGPUProxy* target_proxy, ui32 width, ui32 height)
		: GLES2TargetTaskBase(target_proxy)
		, m_width(width)
		, m_height(height)
	{
	...
	GLES2TargetTaskBindTargetRight::GLES2TargetTaskBindTargetRight(GLES2TargetGPUProxy* target_proxy, ui32 width, ui32 height)
		: GLES2TargetTaskBase(target_proxy)
		, m_width(width)
		, m_height(height)
	{
	...
	GLES2TargetTaskReadPixels::GLES2TargetTaskReadPixels(GLES2TargetGPUProxy* target_proxy, ui32 width, ui32 height, void* pixels)
		: GLES2TargetTaskBase(target_proxy)
		, m_width(width)
		, m_height(height)
		, m_pixels(pixels)
