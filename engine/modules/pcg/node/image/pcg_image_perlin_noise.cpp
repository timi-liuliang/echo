...
namespace Echo
{
	...
	{
		CLASS_BIND_METHOD(PCGImagePerlinNoise, getWidth);
		CLASS_BIND_METHOD(PCGImagePerlinNoise, setWidth);
		CLASS_BIND_METHOD(PCGImagePerlinNoise, getHeight);
		CLASS_BIND_METHOD(PCGImagePerlinNoise, setHeight);
		CLASS_BIND_METHOD(PCGImagePerlinNoise, getAmplitude);
		CLASS_BIND_METHOD(PCGImagePerlinNoise, setAmplitude);
		CLASS_BIND_METHOD(PCGImagePerlinNoise, getGridSize);
		CLASS_BIND_METHOD(PCGImagePerlinNoise, setGridSize);
		CLASS_BIND_METHOD(PCGImagePerlinNoise, getOffset);
		CLASS_BIND_METHOD(PCGImagePerlinNoise, setOffset);
