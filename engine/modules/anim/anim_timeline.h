...
namespace Echo
{
	...
	public:
		...
		void addKey(const String& animName, const String& objectPath, const String& propertyName, int curveIdx, float time, float value);
		void setKey(const String& animName, const String& objectPath, const String& propertyName, int curveIdx, int keyIdx, const Variant& value);
