...
namespace Echo
{
    ParticleSystemRender::ParticleSystemRender()
        : Render()
    {
    }
    ...
    void ParticleSystemRender::bindMethods()
    {
        CLASS_BIND_METHOD(ParticleSystemRender, getMaterial,        DEF_METHOD("getMaterial"));
        CLASS_BIND_METHOD(ParticleSystemRender, setMaterial,        DEF_METHOD("setMaterial"));
    ...
    void ParticleSystemRender::setMaterial(Object* material)
    {
    ...
    void ParticleSystemRender::buildRenderable()
    {
    ...
    void ParticleSystemRender::update_self()
    {
        if (isNeedRender())
        {
            buildRenderable();
    ...
    void ParticleSystemRender::updateMeshBuffer()
    {
        if(!m_mesh)
        {
