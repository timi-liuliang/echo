#ifndef __EFFECT_LAYER_CYLINDERPARTICLE_H__
#define __EFFECT_LAYER_CYLINDERPARTICLE_H__

#include "EffectLayerParticles.h"

namespace Echo
{
	class EffectLayerParticlesCylinder : public EffectLayerParticles
	{
	public:
		static const Vector3 DEFAULT_LP_AREA;
	...
	public:
		EffectLayerParticlesCylinder();
		virtual ~EffectLayerParticlesCylinder();
