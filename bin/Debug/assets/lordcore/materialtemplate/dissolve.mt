...
<MaterialDesc>
	<ShaderPrograme vs="dissolve.vs" ps="dissolve.ps">
		<BlendState>
		</BlendState>
		<RasterizerState>
		</RasterizerState>
		...
		<Macros>
			<Macro value="SURFACE_EDGE_R" default="false" />
			<Macro value="SURFACE_EDGE_G" default="true" />
			<Macro value="SURFACE_EDGE_B" default="false" />
      <Macro value="DISSOLVE_INVERSE" default="false" />
      <Macro value="DISSOLVE_USE_UV" default="false" />
      <Macro value="DISSOLVE_PARAM_U" default="false" />
      <Macro value="DISSOLVE_PARAM_INV_U" default="false" />
      <Macro value="DISSOLVE_PARAM_V" default="false" />
      <Macro value="DISSOLVE_PARAM_INV_V" default="false" />
			<!--Macro value="SURFACE_COLOR" default="false" />
			<Macro value="DISSOLVE_DECREACE" default="false" />
