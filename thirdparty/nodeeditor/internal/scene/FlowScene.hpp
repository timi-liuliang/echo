...
namespace QtNodes
{
    ...
    private:
        ...
        std::unordered_map<QUuid, SharedConnection> m_connections;
        std::unordered_map<QUuid, UniqueNode>       m_nodes;
        std::shared_ptr<DataModelRegistry>          m_registry;
