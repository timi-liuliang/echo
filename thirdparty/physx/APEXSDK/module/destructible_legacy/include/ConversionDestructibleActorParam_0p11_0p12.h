...
#ifndef CONVERSIONDESTRUCTIBLEACTORPARAM_0P11_0P12H_H
#define CONVERSIONDESTRUCTIBLEACTORPARAM_0P11_0P12H_H
...
typedef ParamConversionTemplate<DestructibleActorParam_0p11, DestructibleActorParam_0p12, 11, 12> ConversionDestructibleActorParam_0p11_0p12Parent;

class ConversionDestructibleActorParam_0p11_0p12: ConversionDestructibleActorParam_0p11_0p12Parent
{
public:
...
protected:
	ConversionDestructibleActorParam_0p11_0p12(NxParameterized::Traits* t) : ConversionDestructibleActorParam_0p11_0p12Parent(t) {}
