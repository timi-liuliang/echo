...
#ifndef __EMITTER_GEOM_SPHERE_SHELL_H__
#define __EMITTER_GEOM_SPHERE_SHELL_H__
...
class EmitterGeomSphereShell : public NxEmitterSphereShellGeom, public EmitterGeom
{
public:
	EmitterGeomSphereShell(NxParameterized::Interface* params);

	/* Asset callable methods */
	NxEmitterGeom*				getNxEmitterGeom();
	const NxEmitterSphereShellGeom* isSphereShellGeom() const
	{
		return this;
	}
	...
	void						setShellThickness(physx::PxF32 thickness)
	{
		*mShellThickness = thickness;
	}
	physx::PxF32				getShellThickness() const
	{
...
protected:
	physx::PxVec3				randomPointOnUnitSphere(QDSRand& rand) const;

	NxApexEmitterType::Enum		mType;
	physx::PxF32*				mRadius;
	physx::PxF32*				mShellThickness;
