...
// ---------------------------------------------------------------------------------------
class Delaunay3d : public ::physx::shdfnd::UserAllocated {
...
public:
	...
	const shdfnd::Array<int> getTetras() const { return mIndices; }
...
protected:
	...
	shdfnd::Array<Tetra> mTetras;
	shdfnd::Array<int> mIndices;

	CompoundGeometry mGeom;

	mutable shdfnd::Array<int> mTetMarked;
