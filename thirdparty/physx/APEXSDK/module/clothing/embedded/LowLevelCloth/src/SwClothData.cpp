...
cloth::SwClothData::SwClothData( SwCloth& cloth, const SwFabric& fabric )
{
	...
	mTetherConstraintStiffness = 1.0f - expf(stiffnessExponent * 
	...
	mMotionConstraintStiffness = 1.0f - expf(stiffnessExponent * 
	...
	mSelfCollisionStiffness = 1.0f - expf(stiffnessExponent * 
