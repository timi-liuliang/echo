...
// forward declaration
template <typename> struct Simd4fFactory;

// map Simd4f/Scalar4f to Simd4i/Scalar4i
template <typename> struct Simd4fToSimd4i;
template <> struct Simd4fToSimd4i<Simd4f> { typedef Simd4i Type; };
template <> struct Simd4fToSimd4i<Scalar4f> { typedef Scalar4i Type; };
