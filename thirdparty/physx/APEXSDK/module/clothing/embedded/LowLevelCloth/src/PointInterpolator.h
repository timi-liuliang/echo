...
public:
	...
	UnalignedIterator(const float* pointer)
		: mPointer(pointer)
	{}
...
public:
	...
	inline ConstantIterator& operator++()	{ return *this; }
...
public:
	...
	ScaleBiasIterator(BaseIterator base, 
					  const Simd4f& scale,
					  const Simd4f& bias) 
		: mScale(scale) 
		, mBias(bias)
	...
	inline ScaleBiasIterator& operator++()	{ ++mBaseIterator; return *this; }
