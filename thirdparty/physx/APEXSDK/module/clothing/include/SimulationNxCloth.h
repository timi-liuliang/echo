...
#ifndef SIMULATION_NX_CLOTH_H
#define SIMULATION_NX_CLOTH_H
...
#error "SimulationNxCloth.h must only be included for builds with 2.8.x"
#endif
...
class SimulationNxCloth : public SimulationNxCommon
{
public:
	SimulationNxCloth(ClothingScene* clothingScene, bool useHW);
	virtual ~SimulationNxCloth();

	virtual SimulationType::Enum getType() const { return SimulationType::CLOTH2x; }
