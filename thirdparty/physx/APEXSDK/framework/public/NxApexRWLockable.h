...
#ifndef NX_APEX_RWLOCKABLE_H
#define NX_APEX_RWLOCKABLE_H
...
public:
	...
	purposes.
	*/
	virtual void acquireReadLock(const char *fileName, const PxU32 lineno) const = 0;
	...
	purposes.
	*/
	virtual void acquireWriteLock(const char *fileName, const PxU32 lineno) const = 0;
