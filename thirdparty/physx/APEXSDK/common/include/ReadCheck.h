...
// RAII wrapper around the NxApexScene::apexStartRead() method, note that this
...
private:
	...
	#define NX_READ_ZONE() ReadCheck __readCheck(static_cast<const ApexRWLockable*>(this), __FUNCTION__);
#else
	#define NX_READ_ZONE()
#endif
