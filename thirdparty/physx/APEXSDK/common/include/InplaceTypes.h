...
#define INPLACE_STORAGE_SUB_ARGS_DEF const physx::PxU8* _arg_constMem_, texture<int, 1, cudaReadModeElementType> _arg_texRef_
...
public:
	...
	public:
		...
		APEX_CUDA_CALLABLE PX_INLINE void processType(const physx::PxU8* constMem, T const& value, MT )
		{
			; //do nothing
		}

		template <int _inplace_offset_, typename T>
		APEX_CUDA_CALLABLE PX_INLINE void processPrimitiveType(const physx::PxU8* constMem, T& out)
		{
			out = *reinterpret_cast<const T*>(constMem + _inplace_offset_);
		}
	};
	template <typename T>
	APEX_CUDA_CALLABLE PX_INLINE static void fetchType(T& out, const physx::PxU8* constMem, physx::PxU32 offset0)
	{
	...
	class FetchReflector4TexRef
	{
		...
		APEX_CUDA_CALLABLE PX_INLINE void convertValue(int value, physx::PxI32& out)
		{
			out = physx::PxI32(value);
		}
		APEX_CUDA_CALLABLE PX_INLINE void convertValue(int value, physx::PxU32& out)
		{
			out = physx::PxU32(value);
		}
		APEX_CUDA_CALLABLE PX_INLINE void convertValue(int value, physx::PxF32& out)
		{
	...
	public:
		APEX_CUDA_CALLABLE PX_INLINE FetchReflector4TexRef(physx::PxU32 offset0) : texIdx0(offset0 >> 2) {}
	...
	template <typename T>
	APEX_CUDA_CALLABLE PX_INLINE static void fetchType(T& out, texture<int, 1, cudaReadModeElementType> texRef, physx::PxU32 offset0)
	{
...
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxI32& t) { r.processPrimitiveType<_inplace_offset_>(ra, t); }
};
template <> struct InplaceTypeTraits<physx::PxU32>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxU32& t) { r.processPrimitiveType<_inplace_offset_>(ra, t); }
};
template <> struct InplaceTypeTraits<physx::PxF32>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxF32& t) { r.processPrimitiveType<_inplace_offset_>(ra, t); }
};
template <> struct InplaceTypeTraits<physx::PxVec3>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxVec3& t)
	{
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxVec3, x) + _inplace_offset_>(r, ra, t.x, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxVec3, y) + _inplace_offset_>(r, ra, t.y, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxVec3, z) + _inplace_offset_>(r, ra, t.z, InplaceTypeMemberDefaultTraits());
	}
};
template <> struct InplaceTypeTraits<physx::PxVec4>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxVec4& t)
	{
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxVec4, x) + _inplace_offset_>(r, ra, t.x, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxVec4, y) + _inplace_offset_>(r, ra, t.y, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxVec4, z) + _inplace_offset_>(r, ra, t.z, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxVec4, w) + _inplace_offset_>(r, ra, t.w, InplaceTypeMemberDefaultTraits());
	}
};
template <> struct InplaceTypeTraits<physx::PxMat33Legacy>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxMat33Legacy& t)
	{
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat33Legacy, m) + _inplace_offset_>(r, ra, t.m, InplaceTypeMemberDefaultTraits());
	}
};
template <> struct InplaceTypeTraits<physx::PxMat34Legacy>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxMat34Legacy& t)
	{
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat34Legacy, M) + _inplace_offset_>(r, ra, t.M, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat34Legacy, t) + _inplace_offset_>(r, ra, t.t, InplaceTypeMemberDefaultTraits());
	}
};
template <> struct InplaceTypeTraits<physx::PxBounds3>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxBounds3& t)
	{
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxBounds3, minimum) + _inplace_offset_>(r, ra, t.minimum, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxBounds3, maximum) + _inplace_offset_>(r, ra, t.maximum, InplaceTypeMemberDefaultTraits());
	}
};
template <> struct InplaceTypeTraits<physx::PxPlane>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxPlane& t)
	{
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxPlane, n) + _inplace_offset_>(r, ra, t.n, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxPlane, d) + _inplace_offset_>(r, ra, t.d, InplaceTypeMemberDefaultTraits());
	}
};
template <> struct InplaceTypeTraits<physx::PxMat33>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxMat33& t)
	{
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat33, column0) + _inplace_offset_>(r, ra, t.column0, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat33, column1) + _inplace_offset_>(r, ra, t.column1, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat33, column2) + _inplace_offset_>(r, ra, t.column2, InplaceTypeMemberDefaultTraits());
	}
};
template <> struct InplaceTypeTraits<physx::PxMat44>
{
	template <int _inplace_offset_, typename R, typename RA>
	APEX_CUDA_CALLABLE PX_INLINE static void reflectType(R& r, RA ra, physx::PxMat44& t)
	{
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat44, column0) + _inplace_offset_>(r, ra, t.column0, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat44, column1) + _inplace_offset_>(r, ra, t.column1, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat44, column2) + _inplace_offset_>(r, ra, t.column2, InplaceTypeMemberDefaultTraits());
		InplaceTypeHelper::reflectType<APEX_OFFSETOF(physx::PxMat44, column3) + _inplace_offset_>(r, ra, t.column3, InplaceTypeMemberDefaultTraits());
	}
};
...
public:
	...
	template <typename T>
	APEX_CUDA_CALLABLE PX_INLINE void fetch(StorageSelector<false>, INPLACE_STORAGE_SUB_ARGS_DEF, T& out, physx::PxU32 index = 0) const
	{
	...
	template <typename T>
	APEX_CUDA_CALLABLE PX_INLINE void fetch(StorageSelector<true>, INPLACE_STORAGE_SUB_ARGS_DEF, T& out, physx::PxU32 index = 0) const
	{
		InplaceTypeHelper::fetchType<T>(out, _arg_texRef_, _value + sizeof(T) * index);
	}
#else
	template <typename S, typename T>
	PX_INLINE void fetch(const S& storage, T& out, physx::PxU32 index = 0) const
	{
		storage.fetch(*this, out, index);
	}

	template <typename S, typename T>
	PX_INLINE void update(S& storage, const T& in, physx::PxU32 index = 0) const
	{
...
{
public:
	APEX_CUDA_CALLABLE PX_INLINE physx::PxU32 getSize() const
	{
		return _size;
	}
	...
	template <typename S>
	PX_INLINE void fetchElem(const S& storage, T& out, physx::PxU32 index) const
	{
		storage.fetch(_elems, out, index);
	}
	template <typename S>
	PX_INLINE void updateElem(S& storage, const T& in, physx::PxU32 index) const
	{
		storage.update(_elems, in, index);
	}
	template <typename S>
	PX_INLINE void updateRange(S& storage, const T* in, physx::PxU32 count, physx::PxU32 start = 0) const
	{
	...
	{
		if (storage.realloc<T>(_elems, _size, size))
		{
			_size = size;
			return true;
		}
	...
	APEX_CUDA_CALLABLE PX_INLINE void fetchElem(INPLACE_STORAGE_ARGS_DEF, T& out, physx::PxU32 index) const
	{
