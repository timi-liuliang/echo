...
public:
	...
	*/
	 ...
	 */
	virtual bool			fromMesh(const physx::NxExplicitRenderTriangle* mesh, physx::PxU32 meshSize, const BSPBuildParameters& params, physx::IProgressListener* progressListener = NULL, volatile bool* cancel = NULL) = 0;
	 ...
	 */
	virtual bool			fromConvexPolyhedron(const physx::PxPlane* poly, physx::PxU32 polySize, const physx::PxMat44& internalTransform = physx::PxMat44::createIdentity(), const physx::NxExplicitRenderTriangle* mesh = NULL, physx::PxU32 meshSize = 0) = 0;
	 ...
	 */
	virtual bool			getSurfaceAreaAndVolume(physx::PxF32& area, physx::PxF32& volume, bool inside, Operation::Enum operation = Operation::NOP) const = 0;
	...
	*/
	 ...
	 */
	virtual	void			copy(const IApexBSP& bsp, const physx::PxMat44& tm = physx::PxMat44::createIdentity(), const physx::PxMat44& internalTransform = physx::PxMat44::createZero()) = 0;
	...
	*/
	virtual	void			replaceInteriorSubmeshes(physx::PxU32 frameCount, physx::PxU32* frameIndices, physx::PxU32 submeshIndex) = 0;
