...
static const char* getSemanticName(NxRenderVertexSemantic::Enum semantic)
{
	MI_ASSERT((MiU32)semantic < NxRenderVertexSemantic::NUM_SEMANTICS);
	return (MiU32)semantic < NxRenderVertexSemantic::NUM_SEMANTICS ? sSemanticNamesAndIDs[semantic].m_name : NULL;
}


static MiU32 getSemanticID(NxRenderVertexSemantic::Enum semantic)
{
	MI_ASSERT((MiU32)semantic < NxRenderVertexSemantic::NUM_SEMANTICS);
	return (MiU32)semantic < NxRenderVertexSemantic::NUM_SEMANTICS ? sSemanticNamesAndIDs[semantic].m_id : (MiU32)0;
}



void semanticStruct(MiU32 flags,MiU32 mask,NxRenderVertexSemantic::Enum semantic,NxRenderDataFormat::Enum format,FILE_INTERFACE *fph)
{
	if ( flags & mask )
	{
...
static const char * getFormatString(NxRenderDataFormat::Enum format)
{
	const char *ret = NULL;
	switch ( format )
	{
...
static const char * typeString(NxRenderDataFormat::Enum format)
{
	const char *ret = NULL;
	switch ( format )
	{
...
static void semanticBuffer(MiU32 flags,MiU32 mask,NxRenderDataFormat::Enum format,MiU32 bufferCount,const MiU8 *scan,MiU32 bufferStride,FILE_INTERFACE *fph)
{
...
static void exportSubMesh(Mesh *m,SubMesh *sm,FILE_INTERFACE *fph)
{
  ...
  semanticStruct(flags,MIVF_POSITION,NxRenderVertexSemantic::POSITION,NxRenderDataFormat::FLOAT3,fph);
  semanticStruct(flags,MIVF_NORMAL,NxRenderVertexSemantic::NORMAL,NxRenderDataFormat::FLOAT3,fph);
  semanticStruct(flags,MIVF_TANGENT,NxRenderVertexSemantic::TANGENT,NxRenderDataFormat::FLOAT3,fph);
  semanticStruct(flags,MIVF_BINORMAL,NxRenderVertexSemantic::BINORMAL,NxRenderDataFormat::FLOAT3,fph);
  semanticStruct(flags,MIVF_COLOR,NxRenderVertexSemantic::COLOR,NxRenderDataFormat::UINT1,fph);
  semanticStruct(flags,MIVF_TEXEL1,NxRenderVertexSemantic::TEXCOORD0,NxRenderDataFormat::FLOAT2,fph);
  semanticStruct(flags,MIVF_TEXEL2,NxRenderVertexSemantic::TEXCOORD1,NxRenderDataFormat::FLOAT2,fph);
  semanticStruct(flags,MIVF_TEXEL3,NxRenderVertexSemantic::TEXCOORD2,NxRenderDataFormat::FLOAT2,fph);
  semanticStruct(flags,MIVF_TEXEL4,NxRenderVertexSemantic::TEXCOORD3,NxRenderDataFormat::FLOAT2,fph);
  semanticStruct(flags,MIVF_BONE_WEIGHTING,NxRenderVertexSemantic::BONE_INDEX,NxRenderDataFormat::USHORT4,fph);
  semanticStruct(flags,MIVF_BONE_WEIGHTING,NxRenderVertexSemantic::BONE_WEIGHT,NxRenderDataFormat::FLOAT4,fph);
  ...
  semanticBuffer(flags,MIVF_POSITION,NxRenderDataFormat::FLOAT3, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mPos,sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_NORMAL,NxRenderDataFormat::FLOAT3, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mNormal,sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_TANGENT,NxRenderDataFormat::FLOAT3, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mTangent,sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_BINORMAL,NxRenderDataFormat::FLOAT3, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mBiNormal,sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_COLOR,NxRenderDataFormat::UINT1, tms.mVertexCount, (const MiU8 *)(&tms.mVertices[0].mColor),sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_TEXEL1,NxRenderDataFormat::FLOAT2, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mTexel1,sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_TEXEL2,NxRenderDataFormat::FLOAT2, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mTexel2,sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_TEXEL3,NxRenderDataFormat::FLOAT2, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mTexel3,sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_TEXEL4,NxRenderDataFormat::FLOAT2, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mTexel4,sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_BONE_WEIGHTING,NxRenderDataFormat::USHORT4, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mBone,sizeof(MeshVertex),fph);
  semanticBuffer(flags,MIVF_BONE_WEIGHTING,NxRenderDataFormat::FLOAT4, tms.mVertexCount, (const MiU8 *)tms.mVertices[0].mWeight,sizeof(MeshVertex),fph);
