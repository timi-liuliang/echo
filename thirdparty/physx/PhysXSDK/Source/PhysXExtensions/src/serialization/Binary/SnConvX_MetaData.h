...
//		ExtraDataEntry2			mEntries[256];
	...
	class MetaData : public shdfnd::UserAllocated
	{
		...
		PX_DEPRECATED	bool			load(const char* filename, MetaDataType type);
		...
		inline_	int						getHFTiling()						const	{ return mTiledHeightFieldSamples;	}
