...
PX_FORCE_INLINE void addDiscreteCollisionStatic(PxsParticleCollData& collData,
...
PX_FORCE_INLINE void addDiscreteCollisionDynamic(PxsParticleCollData& collData,
												 const PxVec3& newSurfaceNormal,
												 const PxVec3& newSurfacePos,
...
PX_FORCE_INLINE void addContinuousCollisionStatic(PxsParticleCollData& collData,												   
												  const PxVec3& newSurfaceNormal,
												  const PxVec3& newSurfacePos)		
{
...
PX_FORCE_INLINE void addContinuousCollisionDynamic(PxsParticleCollData& collData,												   
												   const PxVec3& newSurfaceNormal,
												   const PxVec3& newSurfacePos,
												   const PxVec3& newSurfaceVel)		
{
...
PX_FORCE_INLINE void clampToMaxMotion(PxVec3& newPos, const PxVec3& oldPos, PxF32 maxMotionDistance, PxF32 maxMotionDistanceSqr)
{
...
PX_FORCE_INLINE bool applyConstraints(const PxVec3& rayOrig, PxVec3& rayDir, const PxVec3& oldVelocity, const PxsBodyCore*& twoWayBody,
									  PxVec3& shapeNormal, PxVec3& shapeVelocity, const PxsFluidConstraint* constr0, const PxsFluidConstraint* constr1,
				...
				const PxsBodyCore* constr1TwoWayBody, PxU32 particleIndex, const PxsFluidCollisionParameters& params)
{
	...
	if (particle.flags.low & PxvInternalParticleFlag::eANY_CONSTRAINT_VALID)
	{
		...
		bool isColliding = applyConstraints(collData.oldPos, motionDir, oldVelocity, collData.twoWayBody, collData.surfaceNormal, collData.surfaceVel, collData.c0 , collData.c1,
...
//had to reintroduce isStatic for selective read of collData.surfaceVel for the collisionVelocity feature. at this point
//it would probably be better to refactor collisionResponse to take individual particle data as input again (as done for GPU)
void collisionResponse(PxsParticleCollData& collData, bool twoWay, bool isStatic, PxsFluidCollisionParameters& params)
{
	...
	PxVec3 newVel;
	reflectVelocity(newVel, collData.velocity, collData.velocity, surfaceNormal, surfaceVel, collData.origParticleIndex, params);
