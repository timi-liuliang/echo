...
#define CCD_SKIP_JOINT_VS_JOINT					1
#define CCD_MIN_TIME_LEFT						0.01f
#define CCD_ANGULAR_IMPULSE						0

#define CCD_MULTITHREADED						1
...
struct PxsCCDBody
{
	...
	PxU16						mPassDone;					//Whether it has been processed in the current CCD pass
...
struct PxsCCDPair
{
	...
	*/
	PxReal	sweepFindToi(PxsThreadContext& threadContext, PxReal dt, PxU32 pass);
	/**
	...
	*/
	...
	\param[in] dt The time-step
	\param[in] clipTrajectory Indicates whether we clip the body's trajectory to the end pose. Only done in the final pass
...
public:
	...
	*/
	static PxsCCDContext* create(PxsContext* context);
...
protected:
	...
	*/
		PxsCCDContext(PxsContext* context);
	/**
...
private:
	...
	*/
		...
		PxsThreadContext* mCCDThreadContext;
