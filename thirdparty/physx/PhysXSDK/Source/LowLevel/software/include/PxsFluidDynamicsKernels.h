...
#ifndef PXS_FLUID_DYNAMICS_KERNELS_H
#define PXS_FLUID_DYNAMICS_KERNELS_H
...
#ifdef PX_PS3
#define COMPILE_IN_SIMD_DENSITY 0
#define PX_FORCE_INLINE_KERNELS
#else
...
PX_FORCE_INLINE PxF32 calcDensity(const PxF32 distSqr, const PxsFluidDynamicsParameters& params)
{
...
PX_FORCE_INLINE void addDensity(PxsFluidParticle& particleDst, const PxF32 distSqr, const PxsFluidDynamicsParameters& params)
{
...
PX_FORCE_INLINE void addDensity_twoWay(PxsFluidParticle& particleA, PxsFluidParticle& particleB, const PxF32 distSqr, const PxsFluidDynamicsParameters& params)
{
	PX_ASSERT(distSqr <= params.cellSizeSq);
	PxF32 densityStd = calcDensity(distSqr, params);
...
PX_FORCE_INLINE PxVec3 calcForce(const PxsFluidParticle& particleA, const PxsFluidParticle& particleB, const PxF32 distSqr, const PxVec3& distVec, const PxsFluidDynamicsParameters& params)
{
...
PX_FORCE_INLINE void addForce(PxVec3& particleForceDst, const PxsFluidParticle& particleDst, const PxsFluidParticle& particleSrc, const PxF32 distSqr, const PxVec3& distVec, const PxsFluidDynamicsParameters& params)
{
	PX_ASSERT(distSqr <= params.cellSizeSq);
...
PX_FORCE_INLINE void addForce_twoWay(PxVec3& particleAForce, PxVec3& particleBForce, const PxsFluidParticle& particleA, const PxsFluidParticle& particleB, const PxF32 distSqr, const PxVec3& distVec, const PxsFluidDynamicsParameters& params)
{
	PX_ASSERT(distSqr <= params.cellSizeSq);
...
PX_FORCE_INLINE void updateParticleGroupPair(PxVec3* __restrict forceBufA,
													PxVec3* __restrict forceBufB,
													PxsFluidParticle* __restrict particlesSpA,
													PxsFluidParticle* __restrict particlesSpB,
													const PxU32* __restrict particleIndicesSpA,
													const PxU32 numParticlesA,
													const PxU32* __restrict particleIndicesSpB,
													const PxU32 numParticlesB,
													const bool twoWayUpdate,
													const bool isDensityMode,
													const PxsFluidDynamicsParameters& params,
													PxU8* tempSimdPositionBuffer, 
...
template<bool isDensityMode, bool twoWayUpdate>
static void addContribution(PxVec3& forceA, PxVec3& forceB, PxReal distSqr, const PxVec3& distVec, PxsFluidParticle& particleA, PxsFluidParticle& particleB, const PxsFluidDynamicsParameters& params)
{
	if (twoWayUpdate)
	{
		if (isDensityMode)
...
struct PxsFluidDynamicsParametersSIMD
{
...
PX_FORCE_INLINE void calcDensity4_onlyPtrs(Mat44V& posDensDstT,
												  const PxsFluidParticle* __restrict pSrc0,
												  const PxsFluidParticle* __restrict pSrc1,
												  const PxsFluidParticle* __restrict pSrc2,
												  const PxsFluidParticle* __restrict pSrc3,
												  const PxsFluidDynamicsParametersSIMD& params)
{
	Mat44V posDensSrc(
		V4LoadA(&pSrc0->position.x),
		V4LoadA(&pSrc1->position.x),
		V4LoadA(&pSrc2->position.x),
...
PX_FORCE_INLINE void calcDensity4_twoWay_onlyPtrs(Mat44V& posDensDstT,
														 PxsFluidParticle* __restrict pSrc0,
														 PxsFluidParticle* __restrict pSrc1,
														 PxsFluidParticle* __restrict pSrc2,
														 PxsFluidParticle* __restrict pSrc3,
														 const PxsFluidDynamicsParametersSIMD& params)
{
	Mat44V posDensSrc(
		V4LoadA(&pSrc0->position.x),
...
PX_FORCE_INLINE void calcForce4_onlyPtrs(Mat44V& forceDstT,
												const PxsFluidParticle* __restrict pSrc0,
												const PxsFluidParticle* __restrict pSrc1,
												const PxsFluidParticle* __restrict pSrc2,
												const PxsFluidParticle* __restrict pSrc3,
												const Mat44V& posDensDstT,
												...
												const PxsFluidDynamicsParametersSIMD& params)
{
	...
	//pressure force
	Mat44V velPressSrc(
		V4LoadA(&pSrc0->velocity.x),
		V4LoadA(&pSrc1->velocity.x),
		V4LoadA(&pSrc2->velocity.x),
...
PX_FORCE_INLINE void calcForce4_twoWay_onlyPtrs(Mat44V& forceDstT,
													   Mat44V& forceSrcT,
													   PxsFluidParticle* __restrict pSrc0,
													   PxsFluidParticle* __restrict pSrc1,
													   PxsFluidParticle* __restrict pSrc2,
...
static void updateStreamDensity(PxsFluidParticle* __restrict particlesA, const PxsFluidParticle* __restrict particlesB,
								const PxU32* indexStream, const PxU32 indexStreamSize, const PxsFluidDynamicsParameters& params,
								const PxsFluidDynamicsParametersSIMD& simdParams)
{
	...
	while (s < indexStreamSize)
	{
		...
		{
			PxsFluidParticle* __restrict dstParticle = particlesA + dstIdx;
...
static void updateStreamDensityTwoWay(PxsFluidParticle* __restrict particlesA, PxsFluidParticle* __restrict particlesB,
									  const PxU32* indexStream, const PxU32 indexStreamSize, const PxsFluidDynamicsParameters& params, 
									  const PxsFluidDynamicsParametersSIMD& simdParams)
{
	PX_UNUSED(simdParams);
...
static void updateStreamForce(PxVec3* __restrict forceBufA, PxsFluidParticle* __restrict particlesA, const PxsFluidParticle* __restrict particlesB,
							  const PxU32* indexStream, const PxU32 indexStreamSize, const PxsFluidDynamicsParameters& params,
							  const PxsFluidDynamicsParametersSIMD& simdParams)
{
	PxU32 s = 0;
...
static void updateStreamForceTwoWay(PxVec3* __restrict forceBufA, PxVec3* __restrict forceBufB, PxsFluidParticle* __restrict particlesA, PxsFluidParticle* __restrict particlesB,
									const PxU32* indexStream, const PxU32 indexStreamSize, const PxsFluidDynamicsParameters& params,
									const PxsFluidDynamicsParametersSIMD& simdParams)
{
	PX_ASSERT(forceBufB);
	...
	while (s < indexStreamSize)
	{
		...
		for (PxU32 i = 0; i < numLeft; ++i)
		{
			...
			PX_ALIGN(16, PxVec3 distVec) = particlesA[dstIdx].position - particlesB[srcIdx].position;
			PxF32 distSqr = distVec.magnitudeSquared();
			addForce_twoWay(forceBufA[dstIdx], forceBufB[srcIdx], particlesA[dstIdx], particlesB[srcIdx], distSqr, distVec, params);
		}
	}
}

#endif // !defined(PX_APPLE_IOS)

template<bool isDensityMode, bool twoWayUpdate>
PX_FORCE_INLINE_KERNELS static void updateParticleGroupPair_small_template(PxVec3* __restrict forceBufA,
																		   PxVec3* __restrict forceBufB,
																   PxsFluidParticle* __restrict particlesA,
																   PxsFluidParticle* __restrict particlesB,
																   const PxU32* __restrict particleIndicesA,
																   const PxU32 numParticlesA,
																   const PxU32* __restrict particleIndicesB,
																   const PxU32 numParticlesB,
																   const PxsFluidDynamicsParameters& params)
{
	...
	for (PxU32 pA = 0; pA < numParticlesA; pA++)
	{
		...
		PxsFluidParticle& particleA = particlesA[idxA];
		PxVec3& forceA = forceBufA[idxA];
		...
		for(PxU32 pB = 0; pB < num_loopB; pB+=4)
		{
			...
			PxsFluidParticle& particleB0 = particlesB[idxB0];
			PxsFluidParticle& particleB1 = particlesB[idxB1];
			PxsFluidParticle& particleB2 = particlesB[idxB2];
			PxsFluidParticle& particleB3 = particlesB[idxB3];
			...
			{
				addContribution<isDensityMode, twoWayUpdate>(forceA, forceB0, distSqr0, distVec0, particleA, particleB0, params);
			}
			if (u_distSqr1 < u_cellSizeSq && u_distSqr1 > 0)
			{
				addContribution<isDensityMode, twoWayUpdate>(forceA, forceB1, distSqr1, distVec1, particleA, particleB1, params);
			}
			if (u_distSqr2 < u_cellSizeSq && u_distSqr2 > 0)
			{
				addContribution<isDensityMode, twoWayUpdate>(forceA, forceB2, distSqr2, distVec2, particleA, particleB2, params);
			}
			if (u_distSqr3 < u_cellSizeSq && u_distSqr3 > 0)
			{
				addContribution<isDensityMode, twoWayUpdate>(forceA, forceB3, distSqr3, distVec3, particleA, particleB3, params);
			}
		}
		...
		for(PxU32 pB = num_loopB; pB < numParticlesB; pB++)
		{
			...
			PxsFluidParticle& particleB = particlesB[idxB];
			PxVec3& forceB = forceBufB[idxB];
			...
			{
				addContribution<isDensityMode, twoWayUpdate>(forceA, forceB, distSqr, distVec, particleA, particleB, params);
			}
		}
	}
}
...
*/
static void updateParticleGroupPair_simd_template(PxVec3* forceBufA,
												  PxVec3* forceBufB,
												  PxsFluidParticle* particlesA,
												  PxsFluidParticle* particlesB,
												  const PxU32* particleIndicesA,
												  const PxU32 numParticlesA,
												  ...
												  PxU32* tempIndexStream)
{
	...
	{
		const PxsFluidParticle* prtB0 = (q   < numParticlesB) ? particlesB + *(idxB  ) : &fakeParticle;
		const PxsFluidParticle* prtB1 = (q+1 < numParticlesB) ? particlesB + *(idxB+1) : &fakeParticle;
		const PxsFluidParticle* prtB2 = (q+2 < numParticlesB) ? particlesB + *(idxB+2) : &fakeParticle;
		const PxsFluidParticle* prtB3 = (q+3 < numParticlesB) ? particlesB + *(idxB+3) : &fakeParticle;

		Mat44V posDensB_N(
			V4LoadA(&prtB0->position.x),
			V4LoadA(&prtB1->position.x),
			V4LoadA(&prtB2->position.x),
	...
	PxsFluidDynamicsParametersSIMD simdParams;
	...
	VecU32V simdIntOne = VecU32VLoadXYZW(1, 1, 1, 1);
	VecU32V simdIntZero = VecU32VLoadXYZW(0, 0, 0, 0);

	PxU32 indexStreamSize = 0;
	const PxU32* __restrict idxA = particleIndicesA;
	for(PxU32 p = 0; p < numParticlesA; p++, idxA++)
	{
		PxsFluidParticle* __restrict prtA = particlesA + *idxA;
		...
		for (PxU32 q = 0; q < numParticlesB; q += 4, idxB += 4)
		{
			...
			//flush interactions
			if (MAX_INDEX_STREAM_SIZE - indexStreamSize >= (4 + 2)); else //4+2, since we potentially need to add the dst index + the src count as well.
			{
				*interactionCountPtr = indexStreamSize - indexStreamSizeOld;
				...
				{
					if (twoWayUpdate)
						updateStreamForceTwoWay(forceBufA, forceBufB, particlesA, particlesB, tempIndexStream, indexStreamSize, params, simdParams);
					else
						updateStreamForce(forceBufA, particlesA, particlesB, tempIndexStream, indexStreamSize, params, simdParams);
				}
...
#define SIMD_THRESH_SRC 8 // seems to be the best trade-off on xbox 
...
*/
PX_FORCE_INLINE_KERNELS static void updateParticleGroupPair(PxVec3* __restrict forceBufA,
															PxVec3* __restrict forceBufB,
													PxsFluidParticle* __restrict particlesA,
													PxsFluidParticle* __restrict particlesB,
													const PxU32* __restrict particleIndicesA,
													...
													PxU32* tempIndexStream)
{
...
#endif
	{
		if (isDensityMode)
		{
			...
			{
				PX_ASSERT(forceBufB);
				updateParticleGroupPair_small_template<true, true>(forceBufA, forceBufB, particlesA, particlesB, 
					particleIndicesA, numParticlesA, 
					particleIndicesB, numParticlesB, 
					params);
			}
			else
			{
				updateParticleGroupPair_small_template<true, false>(forceBufA, forceBufB, particlesA, particlesB, 
					particleIndicesA, numParticlesA, 
					particleIndicesB, numParticlesB, 
					params);
			}
		...
		else
		{
			...
			{
				PX_ASSERT(forceBufB);
				updateParticleGroupPair_small_template<false, true>(forceBufA, forceBufB, particlesA, particlesB, 
					particleIndicesA, numParticlesA, 
					particleIndicesB, numParticlesB, 
					params);
			}
			...
			{
				updateParticleGroupPair_small_template<false, false>(forceBufA, forceBufB, particlesA, particlesB, 
					particleIndicesA, numParticlesA, 
					particleIndicesB, numParticlesB, 
					params);
			}
	...
	{
		updateParticleGroupPair_simd_template(forceBufA, forceBufB, particlesA, particlesB, 
			particleIndicesA, numParticlesA, 
			particleIndicesB, numParticlesB, 
			params, isDensityMode, twoWayUpdate, 
			(Vec4V*)tempSimdPositionBuffer, tempIndexStream);
	}
#endif
}
...
#endif // PXS_FLUID_DYNAMICS_KERNELS_H
