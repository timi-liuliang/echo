...
PxScene_ContactCorrelationDistance,
PxScene_FrictionOffsetThreshold,
PxScene_MeshContactMargin,
...
PxSimulationStatistics_TotalDiscreteContactPairsAnyShape,
