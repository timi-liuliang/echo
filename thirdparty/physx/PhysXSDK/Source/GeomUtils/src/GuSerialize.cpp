...
void physx::writeChunk(PxI8 a, PxI8 b, PxI8 c, PxI8 d, PxOutputStream& stream)
{
...
static bool ReadWordBuffer(PxU16* dest, PxU32 nb, bool mismatch, PxInputStream& stream)
{
