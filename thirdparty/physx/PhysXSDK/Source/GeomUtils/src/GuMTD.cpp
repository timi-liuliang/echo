...
static bool internalComputeMTD_CapsuleConvex(const Gu::CapsuleV& capsule, const bool idtScale,  Gu::ConvexHullV& convexHullV, const Ps::aos::PsTransformV& transf1,
									   Ps::aos::FloatV& penetrationDepth, Ps::aos::Vec3V& normal)
{
	...
	SupportLocal* map = (idtScale ? (SupportLocal*)PX_PLACEMENT_NEW(buff, SupportLocalImpl<ConvexHullNoScaleV>)((ConvexHullNoScaleV&)convexHullV, transf1, convexHullV.vertex2Shape, convexHullV.shape2Vertex, idtScale) : 
	(SupportLocal*)PX_PLACEMENT_NEW(buff, SupportLocalImpl<ConvexHullV>)(convexHullV, transf1, convexHullV.vertex2Shape, convexHullV.shape2Vertex, idtScale));

	return Gu::computeMTD(capsule, polyData, map, penetrationDepth, normal); 

}

bool Gu::computeMTD_CapsuleConvex(PxVec3& mtd, PxF32& depth, const Capsule& capsule, const PxTransform& capsulePose, const PxConvexMeshGeometry& convexGeom, const PxTransform& convexPose)
{
	...
	// Convex mesh
		...
		Gu::ConvexHullV convexHullV(hull, zeroV, vScale, vQuat); 
...
///////////////////////////////////////////////////////////////////////////////
static bool internalComputeMTD_BoxConvex(const PxVec3 halfExtents, const Gu::BoxV& box, const bool idtScale,  Gu::ConvexHullV& convexHullV, const Ps::aos::PsTransformV& transf0, const Ps::aos::PsTransformV& transf1,
									   Ps::aos::FloatV& penetrationDepth, Ps::aos::Vec3V& normal)
{
	...
	SupportLocal* map1 = (idtScale ? (SupportLocal*)PX_PLACEMENT_NEW(buff, SupportLocalImpl<ConvexHullNoScaleV>)((ConvexHullNoScaleV&)convexHullV, transf1, convexHullV.vertex2Shape, convexHullV.shape2Vertex, idtScale) : 
	(SupportLocal*)PX_PLACEMENT_NEW(buff, SupportLocalImpl<ConvexHullV>)(convexHullV, transf1, convexHullV.vertex2Shape, convexHullV.shape2Vertex, idtScale));

	return Gu::computeMTD(polyData0, polyData1, &map0, map1, penetrationDepth, normal); 
...
static bool internalComputeMTD_ConvexConvex(const bool idtScale0, const bool idtScale1, Gu::ConvexHullV& convexHullV0, Gu::ConvexHullV& convexHullV1, const Ps::aos::PsTransformV& transf0, const Ps::aos::PsTransformV& transf1,
									   Ps::aos::FloatV& penetrationDepth, Ps::aos::Vec3V& normal)
{
	...
	SupportLocal* map0 = (idtScale0 ? (SupportLocal*)PX_PLACEMENT_NEW(buff0, SupportLocalImpl<ConvexHullNoScaleV>)((ConvexHullNoScaleV&)convexHullV0, transf0, convexHullV0.vertex2Shape, convexHullV0.shape2Vertex, idtScale0) : 
	(SupportLocal*)PX_PLACEMENT_NEW(buff0, SupportLocalImpl<ConvexHullV>)(convexHullV0, transf0, convexHullV0.vertex2Shape, convexHullV0.shape2Vertex, idtScale0));

	SupportLocal* map1 = (idtScale1 ? (SupportLocal*)PX_PLACEMENT_NEW(buff1, SupportLocalImpl<ConvexHullNoScaleV>)((ConvexHullNoScaleV&)convexHullV1, transf1, convexHullV1.vertex2Shape, convexHullV1.shape2Vertex, idtScale1) : 
	(SupportLocal*)PX_PLACEMENT_NEW(buff1, SupportLocalImpl<ConvexHullV>)(convexHullV1, transf1, convexHullV1.vertex2Shape, convexHullV1.shape2Vertex, idtScale1));
...
bool Gu::computeMTD_ConvexConvex(PxVec3& mtd, PxF32& depth, const PxConvexMeshGeometry& convexGeom0, const PxTransform& convexPose0, const PxConvexMeshGeometry& convexGeom1, const PxTransform& convexPose1)
{
	...
	// Convex mesh
		...
		Gu::ConvexHullV convexHullV0(hull0, zeroV, vScale0, vQuat0);
	//~Convex mesh
	...
	// Convex mesh
		...
		Gu::ConvexHullV convexHullV1(hull1, zeroV, vScale1, vQuat1);
	//~Convex mesh
...
static bool GeomMTDCallback_CapsuleConvex(GEOM_MTD_CALLBACK_PARAMS)
{
	...
	return computeMTD_CapsuleConvex(mtd, depth, capsule, transform0, convexGeom, transform1);
}
...
static bool GeomMTDCallback_SphereHeightField(GEOM_MTD_CALLBACK_PARAMS)
{
	...
	const Gu::Sphere sphere(transform0.p, sphereGeom.radius);
