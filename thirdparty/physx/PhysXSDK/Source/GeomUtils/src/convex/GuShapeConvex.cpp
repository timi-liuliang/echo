...
//	data.mInternal					= mHullData->mInternal;
	PX_IR(dst->mInternal.mRadius)		= PX_IR(src->mInternal.mRadius);
	PX_IR(dst->mInternal.mExtents[0])	= PX_IR(src->mInternal.mExtents[0]);
	PX_IR(dst->mInternal.mExtents[1])	= PX_IR(src->mInternal.mExtents[1]);
	PX_IR(dst->mInternal.mExtents[2])	= PX_IR(src->mInternal.mExtents[2]);
	#else
