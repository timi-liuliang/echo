...
bool Gu::sweepBoxBox(const Box& box0, const Box& box1, const PxVec3& dir, PxReal length, PxVec3& hit, PxVec3& normal, PxReal& t, PxHitFlags hintFlags)
{
...
//			return false;
	...
	if(col==2)
	{
		computeEdgeEdgeNormal(normal, p1s, p2s-p1s, p3s, p4s-p3s, dir, MinDist);
		normal.normalize();
	}
