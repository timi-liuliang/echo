 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool Gu::BipartiteBoxPruning(const PxBounds3* bounds0, PxU32 nb0, const PxBounds3* bounds1, PxU32 nb1, Ps::Array<PxU32>& pairs, const Axes& axes)
{
	pairs.clear();
	// Checkings
	if(nb0 == 0 || nb1 == 0)
	...
	float* MinPosBounds0 = (float*)PX_ALLOC_TEMP(sizeof(float)*nb0, PX_DEBUG_EXP("Gu::BipartiteBoxPruning"));
	float* MinPosBounds1 = (float*)PX_ALLOC_TEMP(sizeof(float)*nb1, PX_DEBUG_EXP("Gu::BipartiteBoxPruning"));
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool Gu::CompleteBoxPruning(const PxBounds3* bounds, PxU32 nb, Ps::Array<PxU32>& pairs, const Axes& axes)
{
	pairs.clear();
	...
	// Allocate some temporary data
	float* PosList = (float*)PX_ALLOC_TEMP(sizeof(float)*nb, PX_DEBUG_EXP("Gu::CompleteBoxPruning"));
