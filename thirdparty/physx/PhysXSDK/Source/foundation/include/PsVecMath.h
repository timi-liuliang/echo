...
#if defined(PX_X86) || defined(PX_X64) || defined(PX_WINMODERN) || defined(PX_PS3) || defined(PX_X360) || (defined(PX_LINUX) && (defined(PX_X86) || defined(PX_X64))) || (defined(PX_ANDROID) && defined(PX_ARM_NEON)) || defined(PX_XBOXONE) || defined(PX_APPLE)
