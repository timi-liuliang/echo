...
private:
	...
	PX_FORCE_INLINE	const Scb::ParticleSystemBuffer*	getParticleSystemBuffer()	const	{ return (const Scb::ParticleSystemBuffer*)getStream();	}
	PX_FORCE_INLINE	Scb::ParticleSystemBuffer*			getParticleSystemBuffer()			{ return (Scb::ParticleSystemBuffer*)getStream();		}
