...
PhysX_release_common_cflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_release_common_cflags  += -Wno-unused-parameter -Wno-enum-compare
...
$(PhysX_release_bin): $(LowLevel_release_obj) $(LowLevelCloth_release_obj) $(PhysXProfileSDK_release_obj) $(PhysXVisualDebuggerSDK_release_obj) $(PvdRuntime_release_obj) $(PxTask_release_obj) $(SceneQuery_release_obj) $(SimulationController_release_obj) $(PhysX_release_obj) build_LowLevel_release build_LowLevelCloth_release build_PhysXProfileSDK_release build_PhysXVisualDebuggerSDK_release build_PvdRuntime_release build_PxTask_release build_SceneQuery_release build_SimulationController_release 
	mkdir -p `dirname ./../../../Lib/android16/libPhysX3.a`
	@$(AR) rcs $(PhysX_release_bin) $(LowLevel_release_obj) $(LowLevelCloth_release_obj) $(PhysXProfileSDK_release_obj) $(PhysXVisualDebuggerSDK_release_obj) $(PvdRuntime_release_obj) $(PxTask_release_obj) $(SceneQuery_release_obj) $(SimulationController_release_obj) $(PhysX_release_obj)
...
PhysX_debug_common_cflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_debug_common_cflags  += -Wno-unused-parameter -Wno-enum-compare
...
$(PhysX_debug_bin): $(LowLevel_debug_obj) $(LowLevelCloth_debug_obj) $(PhysXProfileSDK_debug_obj) $(PhysXVisualDebuggerSDK_debug_obj) $(PvdRuntime_debug_obj) $(PxTask_debug_obj) $(SceneQuery_debug_obj) $(SimulationController_debug_obj) $(PhysX_debug_obj) build_LowLevel_debug build_LowLevelCloth_debug build_PhysXProfileSDK_debug build_PhysXVisualDebuggerSDK_debug build_PvdRuntime_debug build_PxTask_debug build_SceneQuery_debug build_SimulationController_debug 
	mkdir -p `dirname ./../../../Lib/android16/libPhysX3DEBUG.a`
	@$(AR) rcs $(PhysX_debug_bin) $(LowLevel_debug_obj) $(LowLevelCloth_debug_obj) $(PhysXProfileSDK_debug_obj) $(PhysXVisualDebuggerSDK_debug_obj) $(PvdRuntime_debug_obj) $(PxTask_debug_obj) $(SceneQuery_debug_obj) $(SimulationController_debug_obj) $(PhysX_debug_obj)
	$(ECHO) building $@ complete!
...
PhysX_checked_common_cflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_checked_common_cflags  += -Wno-unused-parameter -Wno-enum-compare
...
$(PhysX_checked_bin): $(LowLevel_checked_obj) $(LowLevelCloth_checked_obj) $(PhysXProfileSDK_checked_obj) $(PhysXVisualDebuggerSDK_checked_obj) $(PvdRuntime_checked_obj) $(PxTask_checked_obj) $(SceneQuery_checked_obj) $(SimulationController_checked_obj) $(PhysX_checked_obj) build_LowLevel_checked build_LowLevelCloth_checked build_PhysXProfileSDK_checked build_PhysXVisualDebuggerSDK_checked build_PvdRuntime_checked build_PxTask_checked build_SceneQuery_checked build_SimulationController_checked 
	mkdir -p `dirname ./../../../Lib/android16/libPhysX3CHECKED.a`
	@$(AR) rcs $(PhysX_checked_bin) $(LowLevel_checked_obj) $(LowLevelCloth_checked_obj) $(PhysXProfileSDK_checked_obj) $(PhysXVisualDebuggerSDK_checked_obj) $(PvdRuntime_checked_obj) $(PxTask_checked_obj) $(SceneQuery_checked_obj) $(SimulationController_checked_obj) $(PhysX_checked_obj)
	$(ECHO) building $@ complete!
...
PhysX_profile_common_cflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_profile_common_cflags  += -Wno-unused-parameter -Wno-enum-compare
...
$(PhysX_profile_bin): $(LowLevel_profile_obj) $(LowLevelCloth_profile_obj) $(PhysXProfileSDK_profile_obj) $(PhysXVisualDebuggerSDK_profile_obj) $(PvdRuntime_profile_obj) $(PxTask_profile_obj) $(SceneQuery_profile_obj) $(SimulationController_profile_obj) $(PhysX_profile_obj) build_LowLevel_profile build_LowLevelCloth_profile build_PhysXProfileSDK_profile build_PhysXVisualDebuggerSDK_profile build_PvdRuntime_profile build_PxTask_profile build_SceneQuery_profile build_SimulationController_profile 
	mkdir -p `dirname ./../../../Lib/android16/libPhysX3PROFILE.a`
	@$(AR) rcs $(PhysX_profile_bin) $(LowLevel_profile_obj) $(LowLevelCloth_profile_obj) $(PhysXProfileSDK_profile_obj) $(PhysXVisualDebuggerSDK_profile_obj) $(PvdRuntime_profile_obj) $(PxTask_profile_obj) $(SceneQuery_profile_obj) $(SimulationController_profile_obj) $(PhysX_profile_obj)
	$(ECHO) building $@ complete!
