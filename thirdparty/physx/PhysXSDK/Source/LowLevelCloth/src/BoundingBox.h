...
template <typename Simd4f>
inline BoundingBox<Simd4f> expandBounds(
	const BoundingBox<Simd4f>& bounds, 
	const Simd4f* pIt, const Simd4f* pEnd)
{
...
template <typename Simd4f>
inline BoundingBox<Simd4f> expandBounds(
	const BoundingBox<Simd4f>& a, 
	const BoundingBox<Simd4f>& b)
{
	BoundingBox<Simd4f> result;
...
template <typename Simd4f>
inline BoundingBox<Simd4f> intersectBounds(
	const BoundingBox<Simd4f>& a, 
	const BoundingBox<Simd4f>& b)
{
	BoundingBox<Simd4f> result;
