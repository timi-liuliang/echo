...
namespace DataFlowProgramming
{
    ...
    unsigned int MixDataModel::nPorts(PortType portType) const
    {
    ...
    NodeDataType MixDataModel::dataType(PortType portType, PortIndex portIndex) const
    {
    ...
    std::shared_ptr<NodeData> MixDataModel::outData(PortIndex portIndex)
    {
