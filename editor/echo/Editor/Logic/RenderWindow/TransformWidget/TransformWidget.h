...
namespace Studio
{
	...
	private:
		...
		void drawCircleRuler(float radius, const Echo::Transform& transform, const Echo::Color& color);

		// fill
		void fillSector(float startRadius, float endRadius, const Echo::Transform& transform, const Echo::Color& color);
